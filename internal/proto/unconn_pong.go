...
func ReadUnconnectedPong(in []byte) (reply *UnconnectedPong, err error) {
	reply = &UnconnectedPong{}
	...
	if reply.Magic, err = readMagic(buf); err != nil {
		return nil, err
	}
...
func (r UnconnectedPong) Build() bytes.Buffer {
